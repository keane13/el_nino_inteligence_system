...
def search_data_agent(client: genai.Client, query: str, context: str, image_data: str = None) -> str:
    ...
    system = (
        ...
        "5. `smooth-reason-491707-f6.el_nino.ketersediaan_air_2018_2026` (Water Supply)\n"
        "   Skema: provinsi (STRING), tahun (INTEGER), bulan (STRING), total_produksi_liter_per_detik (FLOAT), persentase_kapasitas (FLOAT), volume_tampungan_juta_m3 (FLOAT).\n\n"
